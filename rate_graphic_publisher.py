...
def generate_single_poster(currency: str, cur_name_fa: str,
    ...
    if date_strip:
        ...
        _fit_text(
            ...
            padding_x=prof.get("padding_x", 16),
            padding_y=prof.get("padding_y", 10),
            line_spacing=prof.get("line_spacing", 4),
            rtl_lines=date_data["rtl_lines"],
            shadow=True,
            border_color=None,
            border_width=0,
            clean_bg=prof.get("clean_bg", False),
            stroke_width=prof.get("stroke_width", 0),
        )
